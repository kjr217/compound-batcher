...
def test_batcher(dai, cdai, batcher, accounts):
    ...
    for n, investor in enumerate(investors):
        ...
        batcher.userDeposit(constants.DEPOSIT_AMOUNT + n * 100e18, {"from": investor})

    assert batcher.toDeposit() == constants.DEPOSIT_AMOUNT * len(investors) + 3600e18
    ...
    for investor in investors:
        ...
        tx = batcher.userWithdrawAllCTokens({"from": investor})
